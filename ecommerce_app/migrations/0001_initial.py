    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other')], default=('M', 'Male'), max_length=20)),
                ('newsletter_subscription', models.CharField(max_length=255)),
                ('profile_picture_url', models.CharField(max_length=255)),
                ('account_status', models.TextField(choices=[('A', 'Active'), ('I', 'Inactive')], default=('I', 'Inactive'))),
