...
SECRET_KEY = 'django-insecure-^jrrerzn=o@&(u^i&df$arx@uop=)sp-fvyca%tfy&j^aactrd'
...
DATABASES = {
    'default': {
        ...
        'USER': 'coletran',
        'PASSWORD': '123',
        'HOST': 'localhost', # If it's a local database, use 'localhost'
        'PORT': '5432', # Default port for PostgreSQL is 5432
    }
}

AUTH_USER_MODEL = 'ecommerce_app.Users'
# Password validation
